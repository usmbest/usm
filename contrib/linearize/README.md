# Linearize
Construct a linear, no-fork, best version of the Usm blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install usm_hash

https://github.com/citypay/usm_hash
...
JSON-RPC server. Running `usmd` or `usm-qt -server` will be sufficient.
...
* `input`: usmd blocks/ directory containing blkNNNNN.dat
